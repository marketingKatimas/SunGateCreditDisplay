...
//Payday Loan
const DebtConsolidationDetail = document.getElementById('DebtConsolidationDetail');
const DebtConsolidationDetailDes = document.getElementById('DebtConsolidationDetailDes');
...
function updateTitle(language) {
  ...
  function updateDebtConsolidation(language) {
    if (language === 'bm') {
      DebtConsolidationDetail.textContent = 'Penyatuan Hutang';
      DebtConsolidationDetailDes.textContent = 'Jangan biarkan hutang berlambak membebankan anda! Urus dan kurangkan beban faedah dan kawal kewangan anda dengan khidmat penyatuan hutang kami yang berfaedah rendah.';
      ApplyNowServices.textContent = 'Mohon Sekarang';
    } else {
      DebtConsolidationDetail.textContent = 'Debt Consolidation';
      DebtConsolidationDetailDes.textContent = 'Don’t let multiple debts weigh you down! Manage and reduce your interest burden and take control of your finances with our low interest rate solution.';
