...
//Personal Loan
const PersonalLoanDetail = document.getElementById('PersonalLoanDetail');
const PersonalLoanDetailDes = document.getElementById('PersonalLoanDetailDes');
...
function updateTitle(language) {
  ...
  function updatePersonalLoan(language) {
    if (language === 'bm') {
      PersonalLoanDetail.textContent = 'Pembiayaan Peribadi';
      PersonalLoanDetailDes.textContent = ' Dengan pembiayaan peribadi kami, anda akan menerima pelan direka khas berdasarkan kelayakan kredit dan pendapatan anda, agar bayaran balik anda mengikut bajet tanpa membebankan kewangan anda.';
      ApplyNowServices.textContent = 'Mohon Sekarang';
    } else {
      PersonalLoanDetail.textContent = 'Personal Loan';
      PersonalLoanDetailDes.textContent = ' With our personal loan, you will receive a personalised plan based on your credit worthiness and income, so your monthly repayments are well within budget, without overburdening your finance';
