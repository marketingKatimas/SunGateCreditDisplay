...
//Wedding Loan
const WeddingLoanDetail = document.getElementById('WeddingLoanDetail');
const WeddingLoanDetailDes = document.getElementById('WeddingLoanDetailDes');
...
function updateTitle(language) {
  ...
  function updateWeddingLoan(language) {
    if (language === 'bm') {
        WeddingLoanDetail.textContent = 'Pembiayaan Kahwin';
        WeddingLoanDetailDes.textContent = 'Untuk yang ingin berkahwin, biayai majlis kahwin idaman anda dengan pembiayaan perkahwinan kami! Pembiayaan ini merangkumi segala keperluan kahwin anda supaya anda dapat nikmati hari bahagia tanpa gelisah.';
      ApplyNowServices.textContent = 'Mohon Sekarang';
    } else {
        WeddingLoanDetail.textContent = 'Wedding Loan';
        WeddingLoanDetailDes.textContent = 'Getting married? Fund your dream wedding with us! Our wedding loan is designed to cover all your wedding expenses so you can enjoy the day you’ll remember forever.';
