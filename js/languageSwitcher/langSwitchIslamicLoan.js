...
//Islamic Loan
const IslamicLoanDetail = document.getElementById('IslamicLoanDetail');
const IslamicLoanDetailDes = document.getElementById('IslamicLoanDetailDes');
...
function updateTitle(language) {
  ...
  function updateIslamicLoan(language) {
    if (language === 'bm') {
        IslamicLoanDetail.textContent = 'Pembiayaan Islamik';
        IslamicLoanDetailDes.textContent = 'Pembiayaan Islamik kami patuh pada syariah dan mengikuti sistem tawarruq, memastikan pembiayaan kami telus dan adil. Kecapi matlamat kewangan anda dengan yakin dan amanah! ';
      ApplyNowServices.textContent = 'Mohon Sekarang';
    } else {
        IslamicLoanDetail.textContent = 'Islamic Loan';
        IslamicLoanDetailDes.textContent = 'Our Islamic loans are shariah-compliant with complete adherence to the tawarruq system, ensuring transparency and fairness. Pursue your financial goals with us with confidence and trust!';
