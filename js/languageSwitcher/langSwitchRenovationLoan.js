...
//Renovation Loan
const RenovationLoanDetail = document.getElementById('RenovationLoanDetail');
const RenovationLoanDetailDes = document.getElementById('RenovationLoanDetailDes');
...
function updateTitle(language) {
  ...
  function updateRenovationLoan(language) {
    if (language === 'bm') {
        RenovationLoanDetail.textContent = 'Pembiayaan Renovasi';
        RenovationLoanDetailDes.textContent = 'Dapatkan modal untuk ubahsuai rumah anda yang sekarang kepada rumah impian! Berikan interior rupa yang baharu dengan pembiayaan fleksibel kami, pada kadar faedah yang rendah. Jadikan projek ubahsuai rumah anda suatu kenyataan!';
      ApplyNowServices.textContent = 'Mohon Sekarang';
    } else {
        RenovationLoanDetail.textContent = 'Renovation Loan';
        RenovationLoanDetailDes.textContent = 'Get the necessary funds to renovate your current home into your ideal home! Give your interior a fresh new look with our flexible terms with a low interest rate and make your home project a reality!';
